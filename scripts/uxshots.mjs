    ...
    await db.put('insights', {
      ...
      json: {
        ...
        sections: [
          ...
          { theme: '高股息 ETF 除息', newsIds: ['n3'], relatedCodes: ['00878'], observation: '你持有的高股息 ETF 在本週除息，參考價已反映息值，帳面市值的變化有一部分來自這件事而不是漲跌。' },
          // ↑ 示範資料。「你持有的」後面不寫真實代號：這句會出現在截圖裡，讀的人分不出是示範還是真的（2026-09-23）
        ],
