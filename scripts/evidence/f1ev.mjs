// 【本質一次性，保留供重做】用途：範圍外第 1 件：三個 commit 對本機假證交所各跑一次｜比較：77b026d／3e77de1／1d0ba37｜數字在：docs/EVIDENCE_檢查器修補.md「**第 1 件已做**」｜不用守：對明確的舊 commit 量一次，舊版不會再變；新版由常設測試守著（證據檔「盤點」一節）
